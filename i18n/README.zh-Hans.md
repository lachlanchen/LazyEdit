...
| 🧩 运行方式 | `python app.py`（手动）、`./start_lazyedit.sh`（tmux）、可选 `lazyedit.service` |
| 🎯 主要参考文档 | `README.md`、`references/QUICKSTART.md`、`references/API_GUIDE.md`、`references/APP_GUIDE.md` |
...
- 当前仓库包含语言：Arabic、German、English、Spanish、French、Japanese、Korean、Russian、Vietnamese、中文（简体）、中文（繁體）
